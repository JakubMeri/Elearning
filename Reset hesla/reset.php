...
<body>
    ...
    <form action="odoslanie.php" method="post">
        <div class="box">
            <h1>OBNOVENIE HESLA</h1>
            <div class="inputs">
                <label>Email:</label>
                <input class="vstup" type="email" placeholder="Zadaj svoj email" name="email">
                <input class="btn" type="Submit" value="Nové heslo" name="reset">
            </div>
            <div class="prelink">
